...
fun BioFragment() {
    Column(modifier = Modifier.padding(4.dp)) {
        ...
        BioHeaderSection(
            ...
            description = stringResource(id = R.string.welcome_sub_description))
        BioHeaderSection(icon = R.drawable.language_icon,
            title = stringResource(R.string.languages),
            description = stringResource(id = R.string.welcome_sub_description))
        BioDescriptionSection()
        BioHeaderSection(icon = R.drawable.ellipse_22,
...
fun BioHeaderSection(icon: Int, title: String, description: String = "null") {
    Column(modifier = Modifier.fillMaxWidth()) {
        Row(verticalAlignment = Alignment.CenterVertically) {
            ...
            Text(text = title, color = LightBackground, fontSize = 14.sp, fontWeight = FontWeight.Bold)
        }
        Spacer(modifier = Modifier.padding(4.dp))
...
fun BioDescriptionSection() {
    val userDescriptionList = arrayListOf<UserDescriptionItem>(
        UserDescriptionItem(icon = R.drawable.cigarette_icon, title = stringResource(R.string.fumeur), description = "oui"),
        UserDescriptionItem(icon = R.drawable.cup_icon, title = stringResource(R.string.alcohol), description = "oui"),
        UserDescriptionItem(icon = R.drawable.person_search, title = stringResource(R.string.cherche_plus), description = "oui"),
        UserDescriptionItem(icon = R.drawable.two_ppl_icon, title = stringResource(R.string.genre_recherche), description = "Femmes"),
    )
    Column(modifier = Modifier.fillMaxWidth()) {
            LazyVerticalGrid(
                ...
                items(userDescriptionList.size) {
                    Row( verticalAlignment = Alignment.CenterVertically,
                        ...
                        Text(text = userDescriptionList[it].title,
                        ...
                        Text(text = userDescriptionList[it].description,
                            color = Color.Gray,
                            fontSize = 10.sp,
                            maxLines = 1,
                            fontWeight = FontWeight.Medium
