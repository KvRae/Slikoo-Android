...
class RatingViewModel: ViewModel() {
    private var ratings = mutableListOf<Rating>(
        Rating(id = 1, comment = "great i like you slikko", rate = 5, date = Date(), user = "Karam"),
        Rating(id = 2, comment = "Lorem i", rate = 3, date = Date(), user = "Ahmed Mohsen"),
        Rating(id = 3, comment = "helooo guys its amazing", rate = 1, date = Date(), user = "Samir lousif"),
        ...
        Rating(id = 6, comment = "dude im full of energy ilove the way people are using this app its " +
                "so magnificient the way its and how impact it is ", rate = 0, date = Date(), user = "Morad alamdar"),
    )
